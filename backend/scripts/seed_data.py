    ...
    async with AsyncSessionLocal() as session:
        ...
        for place_data in places_data:
            ...
            place = Place(
                ...
                accessible_restroom=map_restroom(
                    place_data.get("accessible_restroom", "none")),
                ...
                lighting_level=map_level(
                    place_data.get("lighting_level", "medium")),
                noise_level=map_level(place_data.get("noise_level", "medium")),
                staff_assistance_available=place_data.get(
                    "staff_assistance_available", False),
                notes=place_data.get("notes"),
                photo_url=place_data.get("photo_url"),
                accessibility_status=map_accessibility_status(
                    place_data.get("accessibility_status", "unknown")),
